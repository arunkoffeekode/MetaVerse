                    ...
                    <div className='row mb-3 justify-content-center'>
                        ...
                        <div className='col-lg-7 col-xl-7 col-xxl-7 col-md-12 col-sm-12'>
                            <div className='app-title'>
                                <h1>Come & explore a Human center metaverse</h1>
                                <p>Our Aim is to bring people together through a virtual reality.
                    ...
                    <div className='row'>
                        <div className='col-lg-12 col-xl-12 col-xxl-12 col-md-12 col-sm-12'>
                            <div className='app-box'>
                                ...
                                <div className='row app-center' style={{ alignItems: 'center' }}>
                                    <div className='col-lg-7 col-md-12 col-sm-12 col-xl-7 col-xxl-7'>
                                        <div className='app-detils'>
                                            <h2>download our app</h2>
                                            <p>Metaverse to provide a comprehensive experience for a human and the whole world for anyone and everyone. Explore the virtual world and start your journey with your <strong>Social-e</strong> </p>
                                ...
                                <div className='row'>
                                    <div className='col-lg-6 col-md-12 col-xl-6 col-xxl-6 col-sm-12'>
                                        <div className='subscribe-details'>
                                            <h2>Ready to be a part of <br />our journey?</h2>
                                            <p>We're building the future of social experiences. Register now to be the first to know about Social-e</p>
                        ...
                        <div className='col-lg-12 col-xl-12 col-xxl-12 col-md-12 col-sm-12'>
                            <div className='footer-content'>
                                <div className='footer-title'>
                                    <div className='title'>Following us yet?</div>
                                </div>
                                <p>Our social media channels provides various updates on our journey, <br />Please follow us and stay up to date.</p>
