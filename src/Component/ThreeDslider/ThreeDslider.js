  ...
  return (
    <div>
      <section className='watch-now c-section'>
        <model-viewer id="prompt-demo" camera-controls touch-action="pan-y" interaction-prompt="none" src="images/Character-standing.glb" alt="Neil Armstrong's Spacesuit from the Smithsonian Digitization Programs Office and National Air and Space Museum" shadow-intensity="1" ar style={{ width: '100%', height: '100vh' }}>
        ...
        <div id="drag-container">
          ...
          <div id="ground"></div>
          {/* <model-viewer src="images/Character-standing.glb" alt="VR Headset" auto-rotate  ar ios-src="images/Character-standing.glb" style={{width:'500px',height:'700px'}} ></model-viewer> */}
